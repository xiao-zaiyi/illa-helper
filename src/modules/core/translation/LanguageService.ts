...
export class LanguageService {
    ...
    private _translationDirectionOptionsCache: TranslationDirectionOption[] | null = null;
    ...
    public getTargetLanguageOptions(): LanguageOption[] {
        if (!this._targetLanguageOptionsCache) {
            const allLanguages = [...this.getPopularLanguages(), ...this.getOtherLanguages()];
...
export const isIntelligentModeEnabled = (config: MultilingualConfig): boolean => {
...
export const getTranslationDirectionOptions = (): TranslationDirectionOption[] => {
